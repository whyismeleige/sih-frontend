    ...
    >
      ...
      >
        ...
        >
          ...
          >
            At Sentinel Travel, your safety comes first.<br></br> Every journey
            we design is built on the pillars of trust, care, and reliability.
            <br></br>So you can focus on exploring the world with peace of mind.
          </Typography>
        </Stack>
        <StyledBox id="image" />
      </Container>
